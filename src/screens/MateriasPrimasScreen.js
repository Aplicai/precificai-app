                          ...
                          >
                            <View style={styles.gridCardTop}>
                              ...
                              <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1, minWidth: 0 }} {...(Platform.OS === 'web' ? { title: item.nome + (marcaVisivel(item.marca) ? ' (' + marcaVisivel(item.marca) + ')' : '') } : {})}>
                                ...
                                {marcaVisivel(item.marca) ? <Text style={[styles.gridCardName, { color: colors.textSecondary, fontWeight: '400', flexShrink: 1, marginLeft: 4 }]} numberOfLines={1}>({marcaVisivel(item.marca)})</Text> : null}
                                <StatusTag item={item} />
                              </View>
                            </View>

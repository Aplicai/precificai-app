                        ...
                        {section.data.map((item) => {
                          ...
                          >
                            <View style={styles.gridCardTop}>
                              ...
                              <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1, minWidth: 0 }} {...(Platform.OS === 'web' ? { title: item.nome + (item.marca ? ' (' + item.marca + ')' : '') } : {})}>
                            ...
                            {/* UX audit 09/09: 2 linhas (nome inteiro em cima) + duplicar/excluir no
                                ...
                                uma embalagem direto da tela no desktop. */}
                            <View style={styles.gridCardBottom}>
                              ...
                              {!bulk.active && (
                                <View style={{ flexDirection: 'row', alignItems: 'center', marginLeft: 6, gap: 2 }}>
                                  <TouchableOpacity
                                    onPress={(e) => { e.stopPropagation && e.stopPropagation(); duplicarEmbalagem(item); }}
                                    style={{ padding: 4 }}
                                    hitSlop={{ top: 6, bottom: 6, left: 6, right: 6 }}
                                    accessibilityRole="button"
                                    accessibilityLabel="Duplicar embalagem"
                                    {...(isWeb ? { title: 'Duplicar embalagem' } : {})}
                                  >
